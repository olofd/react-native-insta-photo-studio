...
export default class ImageCropperView extends Component {
  ...
  getMinimumZoomLevel() {
    ...
    console.log(this.props.window.width / largerFieldValue, this.getMagnification(), imageRatio, this.props.window.width)
  ...
  renderMainImageScrollView() {
    ...
    console.log(minimumZoomScale, maximumZoomScale, previewImageDimensions)
    return (
      <ScrollView
        scrollsToTop={false}
